    ...
    constructor(props) {
        ...
        this.state = {
            formData: {
                ...
                semester: props.foundation.semester || "",
                prefix: props.foundation.prefix || "",
                number: props.foundation.number || "",
                grade: props.foundation.grade || "",
                editing: props.foundation.editing || ""
            }
        }
    }
